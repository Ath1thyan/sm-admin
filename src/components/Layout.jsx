      ...
      <div className="flex flex-grow mt-20">
        ...
        <aside className="w-64 bg-blue-800 text-white shadow-lg fixed top-40 left-0 overflow-auto">
          <nav className="flex flex-col p-4">
            ...
            <Link
              to="/team-members"
              className={`mb-2 ${getActiveClass("/team-members")}`}
            >
              Manage Team Members
            </Link>
            <Link
              to="/contacts"
              className={`mb-2 ${getActiveClass("/contacts")}`}
            >
              Manage Contacts
            </Link>
            <Link
              to="/homepage"
              className={`mb-2 ${getActiveClass("/homepage")}`}
            >
              Manage Home Page
            </Link>
            <Link
              to="/auditpage"
              className={`mb-2 ${getActiveClass("/auditpage")}`}
            >
              Manage Audit Page
            </Link>
            <Link
              to="/aboutpage"
              className={`mb-2 ${getActiveClass("/aboutpage")}`}
            >
              Manage About Page
            </Link>
            <Link
              to="/layoutpage"
              className={`mb-2 ${getActiveClass("/layoutpage")}`}
            >
              Manage Layout Page
            </Link>
            <Link
              to="/newspage"
              className={`mb-2 ${getActiveClass("/newspage")}`}
            >
              Manage News Page
            </Link>
            <Link
              to="/servicepage"
              className={`mb-2 ${getActiveClass("/servicepage")}`}
            >
